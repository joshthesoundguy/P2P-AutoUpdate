...
(function () {
  ...
  function initInquiry() {
    ...
    // populate the dropdown with every piece in the catalogue
    if (sel) {
    ...
    function open(piece, customLabel) {
      ...
      else if (customLabel) { if (sel) sel.value = 'General Inquiry'; if (idField) idField.value = ''; if (msg && !msg.value) msg.value = 'Regarding: ' + customLabel; }
